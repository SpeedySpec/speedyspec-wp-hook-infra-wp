...
final class WP_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $hook_name, $callback, $priority, $accepted_args ) {
		...
		$idx = match ( true ) {
			$callback instanceof HookInvokableInterface,
			$callback instanceof HookActionInterface,
			$callback instanceof HookFilterInterface => $callback->getName(),
			default => _wp_filter_build_unique_id( $hook_name, $callback, $priority ),
		};
